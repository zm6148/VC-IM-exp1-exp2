...
for n_block = Params.current_block : Params.TotalBlocks
    ...
    for n_trial = Params.current_trial : Params.TrialsPerBlock
        ...
        Params.band_list_target(n_block,n_trial,:) = sort(current_bands(1:8));
        Params.band_list_masker(n_block,n_trial,:) = sort(current_bands(9:14));
