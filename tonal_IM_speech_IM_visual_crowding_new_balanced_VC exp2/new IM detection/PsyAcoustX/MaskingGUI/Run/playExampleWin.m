...
% Last Modified by GUIDE v2.5 02-Jul-2012 09:32:50
...
%HP masker level set here.
handles=setHPMaskerBWLvl(handles);
...
%--repeat example until ENTER is pressed-------------------
...
function playExample_FIG_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to playExample_FIG (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
