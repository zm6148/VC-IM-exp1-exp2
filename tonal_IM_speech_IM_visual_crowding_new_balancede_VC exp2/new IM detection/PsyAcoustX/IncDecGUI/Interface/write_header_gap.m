...
fprintf (fid, '\n');
fprintf (fid, '*********************************************************************************\n');
fprintf (fid, 'INC/DEC DETECTION EXPERIMENT\n');
...
makeStimYN=logical([1 stimParams.bnoiseToggle stimParams.precursorToggle 1 1]);
stimClass={'marker';'bnoise';'precursor'; 'gapCenterLoc'; 'initialGapDur'};
